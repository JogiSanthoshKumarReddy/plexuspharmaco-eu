...
export default function FinancialReportPage() {
  const reports = [
    { year: "2023", title: "Annual Financial Report", type: "PDF", file: "/assets/pdfs/Plexuspharmaco_Annual_Financial_Report_2023.pdf", filename: "Plexuspharmaco_Annual_Financial_Report_2023.pdf" },
    { year: "2023", title: "ESG & Sustainability Report", type: "PDF", file: "/assets/pdfs/Plexuspharmaco_ESG_Sustainability_Report_2023.pdf", filename: "Plexuspharmaco_ESG_Sustainability_Report_2023.pdf" },
    { year: "2022", title: "Annual Financial Report", type: "PDF", file: "/assets/pdfs/Plexuspharmaco_Annual_Financial_Report_2022.pdf", filename: "Plexuspharmaco_Annual_Financial_Report_2022.pdf" },
    { year: "2022", title: "Q4 Earnings Release", type: "PDF", file: "/assets/pdfs/Plexuspharmaco_Q4_Earnings_Release_2022.pdf", filename: "Plexuspharmaco_Q4_Earnings_Release_2022.pdf" },
  ];
            ...
            {reports.map((report, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm font-bold text-brand-700 group-hover:text-brand-900 transition-colors">Download PDF</span>
