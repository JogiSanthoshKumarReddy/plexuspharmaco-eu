          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Technology at Plexus Pharmaco is selected and deployed through a structured, evidence-based approach that balances scientific robustness, regulatory acceptability, and commercial scalability. 
              </p>
