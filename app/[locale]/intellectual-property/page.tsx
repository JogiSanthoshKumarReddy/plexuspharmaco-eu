          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Intellectual Property (IP) at Plexus Pharmaco is managed as a strategic asset that safeguards innovation while supporting long-term business sustainability. 
              </p>
