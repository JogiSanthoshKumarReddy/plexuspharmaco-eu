          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Plexus Pharmaco provides end-to-end Contract Manufacturing (CMO), Contract Development and Manufacturing (CDMO), and White Labelling solutions tailored to the evolving needs of global pharmaceutical and healthcare partners.
              </p>
