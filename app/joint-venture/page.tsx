          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                At Plexus Group, joint ventures represent highly integrated, synergistic collaborations that combine complementary strengths, resources, and expertise. We actively seek joint venture opportunities that accelerate market entry, scale manufacturing capabilities, and foster local innovation in target regions.
              </p>
