    ...
    <div className="modern-page-wrapper bg-slate-50 min-h-screen pb-24">
      ...
      <div className="container mx-auto px-6 lg:px-12 mt-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          >
            At Plexus Group, our commitment to scientific excellence spans the entire pharmaceutical lifecycle. Explore our core capabilities in research, advanced manufacturing, and rigorous quality assurance.
          </motion.p>
        </div>
