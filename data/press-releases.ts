...
export const pressReleases: PressRelease[] = [
  ...
  },
  {
    ...
    title: "Plexuspharmaco Announces New R&D Facility in Munich",
    date: "Jul 22, 2026",
    category: "Research",
    ...
    content: "Plexuspharmaco is expanding its European footprint with a new €50M Research & Development center in Munich. The facility will employ over 200 leading scientists dedicated to advancing treatments in oncology and rare diseases. [PENDING CLIENT APPROVAL]"
  },
  {
    ...
    content: "In a major step towards our net-zero goals, Plexuspharmaco proudly announces that all active manufacturing facilities globally have fully transitioned to 100% renewable energy. This milestone reflects our unwavering commitment to environmental sustainability. [PENDING CLIENT APPROVAL]"
  },
  {
    ...
    content: "Plexuspharmaco reported exceptional Q2 financial results, with European revenue growing by 24% year-over-year. The strong performance was spearheaded by our newly launched Dermo-cosmetics line and expanded cardiovascular portfolio. [PENDING CLIENT APPROVAL]"
  }
];
