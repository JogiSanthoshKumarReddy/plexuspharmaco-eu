export const homepageData = {
  hero: {
    ...
    subtitle: "Plexuspharmaco GmbH is a globally focused healthcare company committed to building sustainable value through high-quality and regulatory-compliant healthcare solutions.",
    slides: [
      { id: 1, bg: "/assets/images/hero-1.jpg" },
      { id: 2, bg: "/assets/images/hero-2.jpg" },
      { id: 3, bg: "/assets/images/hero-3.jpg" },
    ]
  },
  highlights: {
    ...
    features: [
      { title: "Manufacturing Capabilities", icon: "factory", desc: "modern, validated facilities ensuring the highest standards of production.", image: "/assets/images/pharma_hero_mfg.png" },
  ...
  usps: {
    ...
    points: [
      { title: "Innovation", desc: "Continuous research and development in modern medicine." },
      { title: "Sustainability", desc: "Eco-friendly practices in our manufacturing pipeline." },
      { title: "Excellence", desc: "Unwavering commitment to quality assurance." }
    ]
  }
};
